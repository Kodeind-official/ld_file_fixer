...
class _DetailPageSPAState extends State<DetailPageSPA> {
  ...
  Future<void> updateStatusReadVendor(String imageId) async {
    ...
    final response = await http.post(
      url,
      body: {'statusReadVendor': 'true', 'imageId': imageId},
    );
  ...
  Future<void> updateStatusReadAdmin(String imageId) async {
    ...
    final response = await http.post(
      url,
      body: {'statusReadAdmin': 'true', 'imageId': imageId},
    );
  ...
  Future<void> updateStatusReadAdmin2(String imageId) async {
    ...
    final response = await http.post(
      url,
      body: {'statusReadAdmin': 'false', 'imageId': imageId},
    );
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          iconTheme: IconThemeData(color: colorSet.mainBG),
          ...
          child: Column(
            ...
            children: [
                        ...
                        errorBuilder:
                            (
                              ...
                              return Container(
                                ...
                                width: double.infinity,
                                color: Colors
                                    .grey, // Warna latar belakang kontainer
                                child: Center(
                                  child: Text(
              ...
              Padding(
                ...
                child: Container(
                  padding: const EdgeInsets.only(left: 25, right: 15, top: 12),
                  height: 45,
                  width: double.infinity,
                  decoration: BoxDecoration(
                      ...
                      child: Row(
                        children: [
                          ...
                          status == 'procurement' &&
                              ...
                              : (widget.imageInfo.statusReadAdmin == 'unread' &&
                                    status != 'vendor')
                              ? Text(
                                  widget.imageInfo.statusIMG,
                                  style: TextStyle(
                                ...
                                InkWell(
                                  onTap: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => FullScreenImagePageResult(
                                          ...
                                          imageData: matchedData.map((data) {
                                            ...
                                            return {
                                              ...
                                              'uploadDate': formatDateYear(
                                                data.tanggal_upload_hari_ini,
                                              ),
                                              'id': data.id,
                                              'similarityPercentage':
                                                  comparisonResult['similarityPercentage'],
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                        color:
                                            ...
                                            ? Colors.red
                                            : Colors
                                                  .transparent, // Kondisi border merah
